...
![06_14_manual_example_05.png]({{"/assets/img/06_14_manual_example_05.png"| relative_url}}){:width="600"}
...
사이트ID가 0건이거나, 값이 unknown이거나, 2건 이상인 경우 <br>
...
로그발생이 0건이거나, 3건 이상인 경우 <br>
 ...
 <br>
로그명 오른쪽에 icon이 노란색이거나, 붉은색인 경우 <br>
 ...
 <br>
광고를 클릭했음에도 불구하고, 네이버 광고 쿠키가 0건이거나, 2건 이하거나, 5건 이상인 경우 <br>
 ...
 <br>
광고를 클릭해서 사이트에 들어갔음에도 불구하고, 네이버 파라미터 `미발생` 인 경우 <br>
...
=> 위 (4-2)를 참고하여 문제의 원인 파악을 해주세요. <br>
 <br>
▶ 비정상적인 경우 예시 <br>
